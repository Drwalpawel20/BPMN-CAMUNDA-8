...
@Component
public class CheckDisabledStudentStatusWorker {

    private static final Logger LOG = LoggerFactory.getLogger(CheckDisabledStudentStatusWorker.class);
    private final DatabaseService databaseService;

    public CheckDisabledStudentStatusWorker(DatabaseService databaseService) {
        this.databaseService = databaseService;
    }

    @JobWorker(type = "disabled-student-check-status")
    public void handleStudentCheck(final JobClient client, final ActivatedJob job) {
        ...
        outputVars.put("is_disabled", Boolean.valueOf(String.valueOf(status.get("is_disabled"))));
